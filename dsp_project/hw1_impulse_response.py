...
def main(cfg: Params) -> None:
    ...
    # Также предполагается, что файлы выровнены по началу. Как этого можно добдиться:
    # > через максимизацию кросс-корреляции
    # > через добавление маркера в аудио (искусственно забиваем единицами примерно 10мс в самом начале,
    # и в записи обрезаем по этому маркеру)
    assert (
